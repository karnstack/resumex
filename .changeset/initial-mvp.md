...
Initial MVP release. Resumex is an AI-first, local-only resume builder for Claude Code: clone the repo, talk to Claude, ship a beautiful, print-native resume. Your content never leaves your machine.
