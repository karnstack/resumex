...
export default function SaasMono() {
  return (
    <PageFrame fitDeps={[]} innerClassName="resume-saas-mono">
      <header className="ss-head">
        <div className="ss-head-top">
          <span className="ss-eyebrow">~/avery — engineer · platform</span>
        </div>
      ...
      <section className="ss-section" data-print-entry="true">
        ...
        <article className="ss-entry" data-print-entry="true">
          <div className="ss-entry-head">
            ...
            <span className="ss-stamp">2024-03 — Present · NYC</span>
          </div>
        ...
        <article className="ss-entry" data-print-entry="true">
          <div className="ss-entry-head">
            ...
            <span className="ss-stamp">2022-08 — 2024-03 · NYC</span>
          </div>
          <ul className="ss-bullets">
            <li>
        ...
        <article className="ss-entry" data-print-entry="true">
          <div className="ss-entry-head">
            ...
            <span className="ss-stamp">2020-01 — 2022-07 · Remote</span>
          </div>
          <ul className="ss-bullets">
            <li>
        ...
        <article className="ss-entry" data-print-entry="true">
          <div className="ss-entry-head">
            ...
            <span className="ss-stamp">2018-05 — 2018-08 · Remote</span>
          </div>
          <ul className="ss-bullets">
