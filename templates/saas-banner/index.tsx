...
export default function SaasBanner() {
  return (
    <PageFrame fitDeps={[]} innerClassName="resume-saas-banner">
      <header className="ss-banner">
        <div className="ss-banner-inner">
          <div className="ss-banner-eyebrow">Engineer · Platform</div>
        ...
        <section className="ss-section" data-print-entry="true">
          ...
          <article className="ss-entry" data-print-entry="true">
            ...
            <ul className="ss-bullets">
              <li>
                Led migration of the events pipeline to a horizontally-sharded Kafka cluster,
                cutting p99 latency 3×.
              </li>
              <li>
